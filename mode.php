...
<div id="page2" class="mode-container" style="display: block;">
...
">MODE:</h1>
  ...
  <button class="button human-button" onclick="startHumanGame()">Human vs. Human</button>
  
  <button class="button ai-button" onclick="showDifficultyPopup()">Human vs. AI</button>
